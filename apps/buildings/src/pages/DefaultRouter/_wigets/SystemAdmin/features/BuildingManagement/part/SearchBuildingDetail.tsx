...
export const SearchBuildingDetail = (): ReactNode => {
  ...
  return (
    <div className='border-2 border-violet-300 p-2 rounded-lg grid grid-rows-[auto_1fr] w-full h-full min-h-0 space-y-4'>
      <div className='grid grid-cols-1 xl:grid-cols-[1fr_auto] space-y-2 gap-x-2'>
        <dl
          className={clsx(
            'grid grid-cols-[80px_auto] w-full h-fit  gap-y-2 text-base',
            'xl:grid-rows-[1fr_1fr_1fr_250px]',
            'grid-rows-[1fr_1fr_1fr_180px]'
          )}
        >
          <dt className='text-slate-500'>건물명</dt>
          <dd className='font-semibold pr-4'>{`${findBuildingId} 강원정보문화산업진흥원`}</dd>
          ...
          <dd className='h-full min-h-0 overflow-y-auto text-justify pr-4 '>
            건물 설명이 이렇게 들어갑니다. 건물 설명이 이렇게 들어갑니다. 건물
            설명이 이렇게 들어갑니다. 건물 설명이 이렇게 들어갑니다.건물 설명이
            이렇게 들어갑니다. 건물 설명이 이렇게 들어갑니다.건물 설명이 이렇게
            들어갑니다. 건물 설명이 이렇게 들어갑니다.건물 설명이 이렇게
            들어갑니다. 건물 설명이 이렇게 들어갑니다.건물 설명이 이렇게
            들어갑니다. 건물 설명이 이렇게 들어갑니다.건물 설명이 이렇게
            들어갑니다. 건물 설명이 이렇게 들어갑니다.건물 설명이 이렇게
            들어갑니다. 건물 설명이 이렇게 들어갑니다.건물 설명이 이렇게
