...
INSERT INTO `BMS_TN_FLOORS` (`building_id`, `index`,`floor_name`, `floor_type`,`floor_glb`,`latitude`, `longitude`, `height`, `heading`) VALUES 
(@init_building_id, 0, '바닥층', 'SURFACE', '/media/glbs/G1.glb', 37.5667, 126.9784, 0, 0),
(@init_building_id, 1, '지상1층', 'FLOOR', '/media/glbs/F_01.glb', 37.56535253323751, 126.98043995723785, 0, 0),
(@init_building_id, 2, '지상2층', 'FLOOR', '/media/glbs/F_02.glb', 37.56535253323751, 126.98043995723785, 0, 0),
(@init_building_id, 3, '지상3층', 'FLOOR', '/media/glbs/F_03.glb', 37.56535253323751, 126.98043995723785, 0, 0),
(@init_building_id, 4, '지상4층', 'FLOOR', '/media/glbs/F_04.glb', 37.56535253323751, 126.98043995723785, 0, 0);
